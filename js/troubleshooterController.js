...
var model = {
	...
	accessibility: {
	    title: "Accessibility",	    
	    inquire: "Can you open the network register page?",
		situation: [		    
		    {
			answer: "Yes",
			next: "os"
	...
	os: {
	    ...
	    inquire: "What is your operation system?",
	    situation: [
		{
		    answer: "Linux or Mac",
		    next: "unixLike"
	...
	hardware: {
	    title: "Hardware",
	    inquire: "If your roomate can connect to the internet, try to connect to the internet using their cable and socket. Can you connect?",
	    situation: [
		{
		    answer: "Yes",
		    next: "cabelOrSocket"
	...
	cabelOrSocket: {
	    ...
	    inquire: "Borrow the cable from your roommate, plug it in your computer and your socket. Can you connect to internet now?",
	    situation: [
		{
		    answer: "Yes",
		    next: "cableBroken"
	...
	cableBroken: {
	    ...
	    inquire: "Try to get another one~",
	    situation: [
		{
		    answer: "Finish",
		    next: "finish"
	...
	computerHardware: {
	    ...
	    inquire: "Your computer hardware may be broken.",
	    situation: [
		{
		    answer: "Ok Bye~",
		    next: "bye"
	...
	ip: {
	    ...
	    inquire: "What is the IP you get?",
	    situation: [
		{
	...
	registerGuide: {
	    title: "Register",
	    inquire: "Now go back to your room, using the network from the socket on the wall. Try if you can go to the register page. And blah~",
	    situation:[
		{
	...
	dhcp: {
	    title: "DHCP Setting",
	    inquire: "Check if you have turn on the DHCP. Blah~~~~",
	    situation: [
		{
	...
	block: {
	    ...
	    inquire: "Go to the page. See if you have been blocked",
	    situation: [
		{
	...
	setIP: {
	    ...
	    inquire: "Go to the rester page to see what is your IP. Then set your IP manually.",
	    situation: [
		{
